...
<cffunction name="init" access="public" output="no" returnType="javaRB" hint="Init">
	<cfscript>
		...
		rbFile=thisDir & "app/assets/resourceBundle/main.properties"; //base resource file
		loadResourceBundle(rbFile);
		getResourceBundle(rbFile);

	</cfscript>
	<cfreturn this>
</cffunction>

<cffunction access="public" name="getResourceBundle" output="No" returntype="any" hint="reads and parses java resource bundle per locale">
...
<cfscript>
	...
	<cfelse><!---
		<cfthrow message="#cferror.message#" detail="#cferror.detail#" type="#cferror.type#">
		--->
	</cfif>
</cffunction>
...
<cffunction name="loadResourceBundle" access="public" output="no" returnType="void" hint="Loads a bundle">
	<cfargument name="rbFile" required="yes" type="string">
	<cfargument name="rbLocale" required="no" type="string" default="en_GB">
...
<cffunction name="get" access="public" output="false" returnType="string" hint="Returns bundle.X, if it exists, and optionally wraps it ** if debug mode.">
	<cfargument name="resource" type="string" required="true">
	<cfset var val = "">
	<cfif not isDefined("variables.resourceBundle")>
		<cfthrow message="Fatal error: resource bundle not loaded.">
	...
	<cfif not structKeyExists(variables.resourceBundle, arguments.resource)>
		<cfset val = "<span style='color:red'>+" & arguments.resource &"+</span>">
	<cfelse>
		<cfset val = variables.resourceBundle[arguments.resource]>
	</cfif>
	<cfreturn val>
...
<cffunction name="getResourceData" access="public" output="false" hint="returns struct of keys">
